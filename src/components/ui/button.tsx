...
type ButtonProps = ButtonOwnProps &
  Omit<React.ComponentProps<typeof ButtonPrimitive>, keyof ButtonOwnProps>

/**
 * `asChild` clones the single React child and applies the button classes to it
 * — handy for rendering a Next.js `<Link>` with button styling without wrapping.
 */
function Button({
  className,
  variant = "default",
